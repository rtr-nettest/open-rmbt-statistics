...
public class BandCalculationUtil {
    ...
    public static abstract class Band {
        ...
        private final double uplinkFrequencyLowerBound;
        private final double uplinkFrequencyUpperBound;
        private final double downlinkFrequencyLowerBound;
        private final double downlinkFrequencyUpperBound;
        private final double uplinkChannelLowerBound;
        private final double uplinkChannelUpperBound;
        ...
        protected Band(int band, double uplinkFrequencyLowerBound, double uplinkFrequencyUpperBound, double downlinkFrequencyLowerBound, double downlinkFrequencyUpperBound, double uplinkChannelLowerBound, double uplinkChannelUpperBound, double channelOffset, String informalName) {
            ...
            this.uplinkFrequencyUpperBound = uplinkFrequencyUpperBound;
            this.downlinkFrequencyLowerBound = downlinkFrequencyLowerBound;
            this.downlinkFrequencyUpperBound = downlinkFrequencyUpperBound;
            this.uplinkChannelLowerBound = uplinkChannelLowerBound;
            this.uplinkChannelUpperBound = uplinkChannelUpperBound;
        ...
        public double getFrequencyDL(double channel) {
            double channelOffset = (!containsDLChannel(channel)) ? 0 : this.channelOffset;
            double frequency = this.downlinkFrequencyLowerBound + getStep() * (channel - (this.uplinkChannelLowerBound - channelOffset));
            frequency = (double) Math.round(frequency * 1000) / 1000;
            return frequency;
        }

        public double getFrequencyUL(double channel) {
            double channelOffset = (!containsULChannel(channel)) ? 0 : -this.channelOffset;
            double frequency = this.downlinkFrequencyLowerBound + getStep() * (channel - (this.uplinkChannelLowerBound - channelOffset));
            frequency = (double) Math.round(frequency * 1000) / 1000;
            return frequency;
        }
