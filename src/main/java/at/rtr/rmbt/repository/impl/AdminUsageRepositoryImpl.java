...
public class AdminUsageRepositoryImpl implements AdminUsageRepository {
    ...
    private final String SQL_PLATFORMS = "SELECT date_trunc('day', time) _day, concat(platform, ' (',status,')') as platform, count(platform) count_platform\n" +
