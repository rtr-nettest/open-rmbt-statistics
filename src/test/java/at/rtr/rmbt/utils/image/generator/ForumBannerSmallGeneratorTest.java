...
class ForumBannerSmallGeneratorTest {
    ...
    @BeforeEach
    void setUp() {
        forumBannerSmallGenerator = new ForumBannerSmallGenerator(resourceLoader);
    }
    ...
    void generateImage_correctInvocation_BufferedImage() throws IOException {
        ...
        var actualResult = forumBannerSmallGenerator.generateImage(imageGenerateDto);
