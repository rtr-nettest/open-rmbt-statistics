...
public interface TestConstants {
    ...
    String DEFAULT_GIT_BUILD_TIME = "DEFAULT_GIT_BUILD_TIME";
    String DEFAULT_CONTROL_SERVER_VERSION = String.format("%s(%s) %s", DEFAULT_GIT_COMMIT_ID_DESCRIBE, DEFAULT_GIT_BRANCH, DEFAULT_GIT_BUILD_TIME);
